...
const founders = [
  {
    ...
    bio: "כלכלן בהשכלתו, תואר בכלכלה ובמנהל עסקים. בעל ניסיון בניהול השקעות בחברת ביטוח מובילה, שם ליווה תיקי השקעות של אלפי חוסכים, וכיום מנהל כ-200 מיליון ₪ עבור לקוחות Keystone. מאמין שכל שקל צריך לעבוד חכם, ושכל החלטה פיננסית מתחילה בשאלה אחת: כמה מס אני משלם על זה? הסגנון שלו, ישיר, מבוסס נתונים, בלי ז׳רגון.",
  },
  {
    name: "שלומי פרידמן",
...
export default function KeystoneAboutPage() {
  return (
    <div dir="rtl" lang="he" className="ks-scope bg-white text-black" style={brand}>
      <KeystoneHeader />
      <main id="main">
        <header className="bg-[#123C3E] py-14 text-white md:py-18">
        ...
        <section className="mx-auto max-w-5xl px-5 py-16 md:py-20">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            {founders.map((f) => (
              ...
              >
                <div className="relative aspect-[4/3] overflow-hidden bg-[#123C3E]/5">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    src={`${BASE}${f.img}`}
                    alt={f.name}
        ...
        {/* ── Closing + CTA ─────────────────────────────────────────────── */}
        <section className="bg-[#123C3E] py-16 text-white md:py-20">
