...
export default function ServicesScroller({ services }: { services: Service[] }) {
  ...
  return (
    <div ref={wrapRef} style={{ height: `${count * 85}vh` }} className="relative bg-[#123C3E]">
      <div className="sticky top-16 h-[calc(100vh-4rem)] w-screen overflow-hidden bg-[#123C3E]">
            ...
            >
              ...
              <div className="relative aspect-[3/2] max-h-[90vh] w-[min(97vw,142vh)] flex-none items-end overflow-hidden rounded-[2rem] text-white shadow-2xl ring-1 ring-white/10">
                ...
                <span
                  ...
                  style={{
                    background:
                      "linear-gradient(to top, rgba(18,60,62,0.92) 0%, rgba(18,60,62,0.5) 45%, rgba(18,60,62,0.12) 100%)",
                  }}
                />
