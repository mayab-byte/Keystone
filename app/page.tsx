...
export default function KeystonePage() {
  return (
    <div dir="rtl" lang="he" className="ks-scope bg-white text-black" style={brand}>
      ...
      {/* ── Why us ─────────────────────────────────────────────────────── */}
      <section className="bg-[#123C3E] py-20 text-white md:py-24">
        <div className="mx-auto max-w-6xl px-5">
      ...
      <section className="relative overflow-hidden bg-white py-16 md:py-20">
        <span
          aria-hidden
          className="pointer-events-none absolute inset-x-0 top-0 h-px bg-[#123C3E]/10"
        />
        <div className="mx-auto max-w-6xl px-5">
      ...
      <section className="border-t border-black/5 bg-ground py-20 md:py-24">
        <div className="mx-auto max-w-6xl px-5">
          ...
          <p className="mt-10 text-center">
            <Link
              href="/blog"
              className="inline-flex items-center gap-2 rounded-full border-2 border-black px-7 py-3 font-semibold transition-colors hover:bg-[#123C3E] hover:text-white"
            >
              לכל המאמרים
              <ArrowLeft aria-hidden className="h-4 w-4" />
            </Link>
      ...
      <section
        id="contact"
        className="relative scroll-mt-20 overflow-hidden bg-[#123C3E] py-20 text-white md:py-24"
      >
        <span
          aria-hidden
