...
export default function ServiceHero({
  ...
  return (
    <section
      ...
      className="relative h-[44vh] min-h-[340px] overflow-hidden bg-[#000000] md:h-[54vh]"
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to top, rgba(0,0,0,0.90) 0%, rgba(0,0,0,0.5) 45%, rgba(0,0,0,0.28) 100%)",
        }}
      />
