...
export default function ServiceHero({
  ...
  return (
    <section
      ...
      className="relative h-[44vh] min-h-[340px] overflow-hidden bg-[#123C3E] md:h-[54vh]"
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to top, rgba(18,60,62,0.90) 0%, rgba(18,60,62,0.5) 45%, rgba(18,60,62,0.28) 100%)",
        }}
      />
