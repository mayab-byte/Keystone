...
export default function LeadForm({
  ...
  const labelCls = dark ? "text-white" : "text-[#061e13]";
  ...
  const fieldCls =
    "w-full rounded-xl border border-black/25 bg-white px-4 py-3 text-[#061e13] placeholder:text-black/55 focus:border-(--ks-teal)";
